...
<body>
	...
	<div class="header">
		<div>
			<a href="./index"><img src="./images/horizonAirwaysLogo.png" alt="logo" width="200px" height="100px" /></a>
		</div>
	...
	<c:if test="${not empty sessionScope.user}">
		<c:if test="${not empty admin }">
			...
			<a href="./SearchPassenger"><b>Search by PNR</b></a>
	</c:if>
	</div>
	...
	<div>	
		<table class="tblDesign">
			...
			<tr class="detailItem">
				...
				<td>${flightSchedule.weekDay1 } - ${flightSchedule.weekDay2 }</td>
				...
				<td><a href="./findflights?flightNo=${flightSchedule.flightNo}&amp;sectorId=${flightSchedule.sectorId}">
					<b>Find a flight</b></a>
				</td>
			</tr>
			</c:forEach>
